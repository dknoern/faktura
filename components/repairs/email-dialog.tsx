...
export function EmailDialog({ open, onOpenChange, repairId }: EmailDialogProps) {
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Send Repair via Email
          </DialogTitle>
          <DialogDescription>
            Enter one or more email addresses (comma-separated) to send this repair to.
          </DialogDescription>
        </DialogHeader>
